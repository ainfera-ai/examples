# AGENTS.md — operating contract for ainfera-crewai

Audience: the Ainfera fleet (Aulë and peers) and any agent operating this repo. Read before touching code.

## Identity
- **Adapter** — CrewAI + **Ainfera Routing** — multi-agent crews with one audit chain. One of the public framework adapters (siblings: `ainfera-langchain`, `ainfera-langgraph`, `ainfera-letta`, …). A *customer-integration* surface, not core infra.
