#!/usr/bin/env bash
# ainfera-microsoft-agent-framework — minimal curl-only flow, no Microsoft Agent Framework install needed.
#
# Mirrors what the package does: signup → OpenAI-compat inference → audit verify.
set -euo pipefail
