# AGENTS.md — operating contract for ainfera-microsoft-agent-framework

Audience: the Ainfera fleet (Aulë and peers) and any agent operating this repo. Read before touching code.

## Identity
- **Adapter** — Microsoft Agent Framework + **Ainfera Routing**. One of the public framework adapters (siblings: `ainfera-langchain`, `ainfera-pydantic`, `ainfera-letta`, …). A *customer-integration* surface, not core infra.
