# AGENTS.md — operating contract for ainfera-llamaindex

Audience: the Ainfera fleet (Aulë and peers) and any agent operating this repo. Read before touching code.

## Identity
- **Adapter** — LlamaIndex + **Ainfera Routing** — RAG agents on OpenAI-compat inference. One of the public framework adapters (siblings: `ainfera-langchain`, `ainfera-langgraph`, `ainfera-letta`, …). A *customer-integration* surface, not core infra.
