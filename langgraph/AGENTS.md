# AGENTS.md — operating contract for ainfera-langgraph

Audience: the Ainfera fleet (Aulë and peers) and any agent operating this repo. Read before touching code.

## Identity
- **Adapter** — LangGraph + **Ainfera Routing** — orchestration graphs with signed audit per node. One of the public framework adapters (siblings: `ainfera-langchain`, `ainfera-crewai`, `ainfera-letta`, …). A *customer-integration* surface, not core infra.
