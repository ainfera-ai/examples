#!/usr/bin/env bash
# ainfera-langchain — minimal curl-only flow, no LangChain install needed.
#
# Mirrors what main.py does: signup → OpenAI-compat inference → audit verify.
set -euo pipefail
