# AGENTS.md — operating contract for ainfera-google-adk

Audience: the Ainfera fleet (Aulë and peers) and any agent operating this repo. Read before touching code.

## Identity
- **Adapter** — Google ADK + **Ainfera Routing** (LiteLLM → OpenAI-compat → Ainfera). One of the public framework adapters (siblings: `ainfera-langchain`, `ainfera-langgraph`, `ainfera-letta`, …). A *customer-integration* surface, not core infra.
