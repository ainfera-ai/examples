#!/usr/bin/env bash
# ainfera-openclaw — minimal curl-only flow, no openclaw install needed.
#
# Shows what openclaw does under the hood when pointed at Ainfera:
